...
1. **Source Code**: All Python scripts (`.py`), conversion logic, and TensorRT wrappers provided in this repository are licensed under the [MIT License](LICENSE).
2. **SAM 3 Materials & Derivatives**: The underlying model weights, architectures, and **all exported ONNX/TensorRT engines** generated by these scripts are subject to the **[Meta SAM License](LICENSE-SAM)**. 
